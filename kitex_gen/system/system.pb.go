...
var file_ActiManage_system_system_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92, 0x0a, 0x0a, 0x0d, 0x53, 0x79, 0x73,
	...
	0x61, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x43, 0x0a, 0x11, 0x53, 0x74, 0x73, 0x53,
	0x65, 0x6e, 0x64, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x1c, 0x2e,
	0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2e, 0x53, 0x74, 0x73, 0x53, 0x65, 0x6e, 0x64, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x10, 0x2e, 0x73, 0x79,
	0x73, 0x74, 0x65, 0x6d, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x3b, 0x5a,
...
var file_ActiManage_system_system_proto_goTypes = []interface{}{
	...
	(*StsSendVerifyCodeReq)(nil),   // 18: system.StsSendVerifyCodeReq
	(*MerchantLoginResp)(nil),      // 19: system.MerchantLoginResp
	(*Response)(nil),               // 20: system.Response
	(*GetMerchantSettingResp)(nil), // 21: system.GetMerchantSettingResp
	(*ListActivitiesResp)(nil),     // 22: system.ListActivitiesResp
	(*GetActivityResp)(nil),        // 23: system.GetActivityResp
	(*AdminLoginResp)(nil),         // 24: system.AdminLoginResp
	(*GetMerchantInfoResp)(nil),    // 25: system.GetMerchantInfoResp
	(*ListMerchantsResp)(nil),      // 26: system.ListMerchantsResp
}
var file_ActiManage_system_system_proto_depIdxs = []int32{
	...
	18, // 18: system.SystemService.StsSendVerifyCode:input_type -> system.StsSendVerifyCodeReq
	19, // 19: system.SystemService.MerchantLogin:output_type -> system.MerchantLoginResp
	20, // 20: system.SystemService.MerchantSetPassword:output_type -> system.Response
	20, // 21: system.SystemService.UpdateMerchantSetting:output_type -> system.Response
	21, // 22: system.SystemService.GetMerchantSetting:output_type -> system.GetMerchantSettingResp
	20, // 23: system.SystemService.UpdateMerchantInfo:output_type -> system.Response
	20, // 24: system.SystemService.CreateActivity:output_type -> system.Response
	20, // 25: system.SystemService.TopActivity:output_type -> system.Response
	20, // 26: system.SystemService.DeleteActivity:output_type -> system.Response
	20, // 27: system.SystemService.UpdateActivity:output_type -> system.Response
	22, // 28: system.SystemService.ListActivities:output_type -> system.ListActivitiesResp
	23, // 29: system.SystemService.GetActivity:output_type -> system.GetActivityResp
	24, // 30: system.SystemService.AdminLogin:output_type -> system.AdminLoginResp
	20, // 31: system.SystemService.AdminSetPassword:output_type -> system.Response
	20, // 32: system.SystemService.CreateMerchant:output_type -> system.Response
	20, // 33: system.SystemService.UpdateMerchant:output_type -> system.Response
	20, // 34: system.SystemService.DeleteMerchant:output_type -> system.Response
	25, // 35: system.SystemService.GetMerchantInfo:output_type -> system.GetMerchantInfoResp
	26, // 36: system.SystemService.ListMerchants:output_type -> system.ListMerchantsResp
	20, // 37: system.SystemService.StsSendVerifyCode:output_type -> system.Response
