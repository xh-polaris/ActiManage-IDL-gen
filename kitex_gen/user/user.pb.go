...
var file_ActiManage_user_user_proto_rawDesc = []byte{
	...
	0x32, 0xad, 0x11, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	,
	...
	0x4d, 0x65, 0x72, 0x63, 0x68, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x79, 0x42, 0x6f, 0x6f, 0x6b,
	...
	0x75, 0x0a, 0x1e, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x49,
	0x64, 0x42, 0x79, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x61, 0x6e,
	0x6b, 0x12, 0x28, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x73, 0x42, 0x79, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x52, 0x61, 0x6e, 0x6b, 0x52, 0x65, 0x71, 0x1a, 0x29, 0x2e, 0x75, 0x73,
	...
	0x6e, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x12, 0x58, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x56, 0x69, 0x65,
	0x77, 0x44, 0x61, 0x74, 0x61, 0x42, 0x79, 0x4d, 0x65, 0x72, 0x63, 0x68, 0x61, 0x6e, 0x74, 0x12,
	0x1e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x56, 0x69, 0x65, 0x77, 0x44, 0x61,
	0x74, 0x61, 0x42, 0x79, 0x4d, 0x65, 0x72, 0x63, 0x68, 0x61, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x1a,
	0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x56, 0x69, 0x65, 0x77, 0x44, 0x61,
...
var file_ActiManage_user_user_proto_goTypes = []interface{}{
	...
	(*ListActivityIdsByViewReq)(nil),                 // 25: user.ListActivityIdsByViewReq
	(*ListMerchantIdsByViewRankReq)(nil),             // 26: user.ListMerchantIdsByViewRankReq
	(*ListMerchantIdsByBookRecordRankReq)(nil),       // 27: user.ListMerchantIdsByBookRecordRankReq
	(*ListActivityIdsByBookRecordRankReq)(nil),       // 28: user.ListActivityIdsByBookRecordRankReq
	(*GetViewDataByMerchantReq)(nil),                 // 29: user.GetViewDataByMerchantReq
	(*UserSignUpResp)(nil),                           // 30: user.UserSignUpResp
	(*UserLoginResp)(nil),                            // 31: user.UserLoginResp
	(*GetUserInfoResp)(nil),                          // 32: user.GetUserInfoResp
	(*Response)(nil),                                 // 33: user.Response
	(*ListReserversResp)(nil),                        // 34: user.ListReserversResp
	(*GetBookRecordResp)(nil),                        // 35: user.GetBookRecordResp
	(*ListBookRecordsByUserResp)(nil),                // 36: user.ListBookRecordsByUserResp
	(*ListBookRecordsByActivityResp)(nil),            // 37: user.ListBookRecordsByActivityResp
	(*CheckBookRecordByUserIdAndActivityIdResp)(nil), // 38: user.CheckBookRecordByUserIdAndActivityIdResp
	(*ListReceiptsResp)(nil),                         // 39: user.ListReceiptsResp
	(*GetFavoriteAndViewOfActivityResp)(nil),         // 40: user.GetFavoriteAndViewOfActivityResp
	(*GetViewOfMerchantResp)(nil),                    // 41: user.GetViewOfMerchantResp
	(*ListActivityIdsByViewResp)(nil),                // 42: user.ListActivityIdsByViewResp
	(*ListMerchantIdsByViewRankResp)(nil),            // 43: user.ListMerchantIdsByViewRankResp
	(*ListMerchantIdsByBookRecordRankResp)(nil),      // 44: user.ListMerchantIdsByBookRecordRankResp
	(*ListActivityIdsByBookRecordRankResp)(nil),      // 45: user.ListActivityIdsByBookRecordRankResp
	(*GetViewDataByMerchantResp)(nil),                // 46: user.GetViewDataByMerchantResp
}
var file_ActiManage_user_user_proto_depIdxs = []int32{
	...
	25, // 25: user.UserService.ListActivityIdsByView:input_type -> user.ListActivityIdsByViewReq
	26, // 26: user.UserService.ListMerchantIdByViewRank:input_type -> user.ListMerchantIdsByViewRankReq
	27, // 27: user.UserService.ListMerchantIdByBookRecordRank:input_type -> user.ListMerchantIdsByBookRecordRankReq
	28, // 28: user.UserService.ListActivityIdByBookRecordRank:input_type -> user.ListActivityIdsByBookRecordRankReq
	29, // 29: user.UserService.GetViewDataByMerchant:input_type -> user.GetViewDataByMerchantReq
	30, // 30: user.UserService.UserSignUp:output_type -> user.UserSignUpResp
	31, // 31: user.UserService.UserLogin:output_type -> user.UserLoginResp
	32, // 32: user.UserService.GetUserInfo:output_type -> user.GetUserInfoResp
	33, // 33: user.UserService.UpdateUserInfo:output_type -> user.Response
	33, // 34: user.UserService.SetPassword:output_type -> user.Response
	33, // 35: user.UserService.SetNotice:output_type -> user.Response
	33, // 36: user.UserService.CreateReserver:output_type -> user.Response
	33, // 37: user.UserService.DeleteReserver:output_type -> user.Response
	33, // 38: user.UserService.UpdateReserver:output_type -> user.Response
	34, // 39: user.UserService.ListReservers:output_type -> user.ListReserversResp
	33, // 40: user.UserService.CreateBookRecord:output_type -> user.Response
	33, // 41: user.UserService.CancelBookRecord:output_type -> user.Response
	35, // 42: user.UserService.GetBookRecordDetail:output_type -> user.GetBookRecordResp
	36, // 43: user.UserService.ListBookRecordsByUser:output_type -> user.ListBookRecordsByUserResp
	37, // 44: user.UserService.ListBookRecordsByActivity:output_type -> user.ListBookRecordsByActivityResp
	38, // 45: user.UserService.CheckBookRecordByUserIdAndActivityId:output_type -> user.CheckBookRecordByUserIdAndActivityIdResp
	33, // 46: user.UserService.CreateReceipt:output_type -> user.Response
	33, // 47: user.UserService.DeleteReceipt:output_type -> user.Response
	39, // 48: user.UserService.ListReceipts:output_type -> user.ListReceiptsResp
	33, // 49: user.UserService.MarkReceiptRead:output_type -> user.Response
	33, // 50: user.UserService.DoFavorite:output_type -> user.Response
	33, // 51: user.UserService.CancelFavorite:output_type -> user.Response
	33, // 52: user.UserService.CreateView:output_type -> user.Response
	40, // 53: user.UserService.GetFavoriteAndViewOfActivity:output_type -> user.GetFavoriteAndViewOfActivityResp
	41, // 54: user.UserService.GetViewOfMerchant:output_type -> user.GetViewOfMerchantResp
	42, // 55: user.UserService.ListActivityIdsByView:output_type -> user.ListActivityIdsByViewResp
	43, // 56: user.UserService.ListMerchantIdByViewRank:output_type -> user.ListMerchantIdsByViewRankResp
	44, // 57: user.UserService.ListMerchantIdByBookRecordRank:output_type -> user.ListMerchantIdsByBookRecordRankResp
	45, // 58: user.UserService.ListActivityIdByBookRecordRank:output_type -> user.ListActivityIdsByBookRecordRankResp
	46, // 59: user.UserService.GetViewDataByMerchant:output_type -> user.GetViewDataByMerchantResp
